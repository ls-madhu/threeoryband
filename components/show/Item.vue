<template>
  <article
    ...
    <div class="flex flex-row sm:flex-col items-center rounded-sm text-sm font-semibold border-2">
    ...
    <div class="flex flex-col gap-1.5">
      ...
      <div class="mt-2 flex gap-4">
        <NuxtLink
          class="flex items-center gap-1 rounded-sm px-2 py-1 border border-white transition-colors hover:text-gray-900 hover:bg-white"
          :external="true"
          target="_blank"
          to="/">
